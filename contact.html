...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td align="center"><table width="1260" border="0" cellspacing="5" cellpadding="0" align="center">
      <tr>
  ...
  <tr>
    <td class="tablebg"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
   <td><div class="welcome">Contact</div><br />
   <p><em></em></p>
<p>To contact Sifu Anthony Spinicchia with questions please fill out the form below and you will be contacted ASAP. Your information will not be shared with anyone.</p>
        ...
        <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td><input name="textfield" type="text" id="textfield" value="" maxlength="30" /></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><strong>How did you hear about <br />
  ...
  <input name="redirect" value="http://www.elitechikung.com/contact.html" type="hidden">
              ...
              <p>via mail at</p>
              <p>Anthony Spinicchia</p>
              <p>72 W. Horizon Ridge Parkway, 120-191</p>
              <p>Henderson, NV 89012</p></td>
          </tr>
        </table>
       </form>  
      </td>
